...
<?php foreach($list as $id => $item):?>
	<div class="banneritem" id="__banneritem<?php echo $id; ?>" 
        <?php if($id != 0): ?>
        style="display: none"
        <?php endif; ?>
    >
...
function activateOneBanner(which, bannerCount, interval) {
    ...
    for(var i = 0; i < bannerCount; ++i) {
        var e = document.getElementById("__banneritem" + i);
    ...
    which += 1; 
    if(which == bannerCount) {
        which = 0; 
    }
    
    var interval = setTimeout(function() { activateOneBanner(which, bannerCount, interval); }, 10000);
}
//--></script>
